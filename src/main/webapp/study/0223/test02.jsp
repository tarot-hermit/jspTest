...
<p><br/></p>
<div class="container">
  <h2 class="mb-3">이곳은 test02.jsp입니다.</h2>
  <form name="myform" method="post" action="<%=request.getContextPath()%>/j0223/Test02">
  	...
  	<div class="mb-3">나이 : <input type="number" name="age" value="20" class="form-control" /></div>
  	<div class="mb-3">
